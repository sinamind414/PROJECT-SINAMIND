...
*S0–S22 : T1–T3, N1–N2, `/api/grade`, adaptateurs, G11, hash, mixins + `$lex:`, v2/methodology/JS gelés, UI 2 axes, drill/exercices/schéma gelés, métriques, colonnes 035, cache C1+sha16, chatbot ungraded, quota `ok`+`defer` (S22) + FSRS, `validate_rubrics` G5+négatifs+`counter_examples`, stuffing/science hors `method_percent` (`GRADER_VERSION=1.1.5`), `evaluate.py` hors registre.*
