...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 720 420">
  ...
  <text x="370" y="300" text-anchor="middle" fill="#fbbf24" font-family="Arial" font-size="11">غوص</text>
  ...
  <text x="360" y="390" text-anchor="middle" fill="#d1d5db" font-family="Arial" font-size="18">مقطع يوضح ظاهرة الغوص والبنيات المرتبطة بها</text>
</svg>`)
  ...
  documents: [
    ...
    },
    {
      ...
      rows: [
        ...
        { cells: ["البرنس", "30-2900", "صلبة لزجة", "3.3-5.7"] },
    ...
    },
    {
      ...
      caption: "مقطع يبين الطبقات المختلفة للكرة الأرضية: القشرة، البرنس، النواة الخارجية، النواة الداخلية.",
      src: earthSvg,
      alt: "مقطع عرضي في الكرة الأرضية يبين القشرة والبرنس والنواة الخارجية والنواة الداخلية",
      annotations: [
  ...
  questions: [
    {
      ...
      modelAnswer: "تمثل المنحنيات تغير سرعة الموجات P و S بالعمق. الموجات P تنتقل بسرعات مختلفة عبر جميع الطبقات (6-13 كم/ثا) مع تغيرات مفاجئة عند حدود الطبقات. الموجات S تنتقل عبر القشرة والبرنس (4-7 كم/ثا) لكنها تنعدم تماما في النواة الخارجية (0 كم/ثا).",
...
const tectonicsGeneralScenario: MethodologyScenario = {
  ...
  documents: [
    ...
    },
    {
      ...
      caption: "الآليات المسؤولة عن حركة الصفائح التكتونية من تيارات الحمل إلى غوص الصفائح.",
      steps: ["حرارة باطن الأرض", "تيارات حمل", "تصاعد الصهارة", "حركة الصفائح", "غوص/توسع"],
    ...
    },
    {
      ...
      rows: [
        ...
        { cells: ["تقاربي", "اقتراب", "غوص/تصادم", "جبال الأنديز/الهيمالايا"] },
  ...
  questions: [
    ...
    },
    {
      ...
      modelAnswer: "تتسبب تيارات الحمل الناتجة عن حرارة باطن الأرض (الوثيقة 2) في حركة الصفائح حيث تصعد الصهارة عند الحدود التباعدية مسببة توسعا محيطيا وتغوص عند الحدود التقاربية مسببة غوصاً (الوثيقة 3). هذه الحركات المستمرة تدفع وتسحب الصفائح.",
    ...
    },
    {
      ...
      modelAnswer: "تختلف حدود الصفائح في نوع الحركة: التباعدية (ابتعاد) تؤدي إلى توسع محيطي، التقاربية (اقتراب) تؤدي إلى غوص أو تصادم، والتحويلية (انزلاق) تؤدي إلى زلازل. أمثلة: التباعدي في ظهر الأطلسي، التقاربي في الأنديز، والتحويلي في فالق سان أندرياس.",
...
const subductionCollisionRidgeScenario: MethodologyScenario = {
  ...
  title: "الغوص والتصادم والظهر المحيطي",
  subtitle: "وضعية تعلمية: البنيات الجيولوجية المرتبطة بحركة الصفائح",
  contextAr: "يرتبط النشاط التكتوني بظواهر جيولوجية مختلفة كالغوص والتصادم. تهدف هذه الوضعية إلى دراسة هذه البنيات.",
  dominantSkills: ["analyse", "interpret", "compare", "relationship", "scientific-text"],
  documents: [
    {
      type: "bar-chart",
      id: "doc1-earthquake-depth",
      title: "الوثيقة 1: توزيع الزلازل حسب العمق في منطقة غوص",
      caption: "عدد الزلازل المسجلة في منطقة غوص حسب عمق بؤرتها.",
      xLabel: "العمق (كم)",
      yLabel: "عدد الزلازل",
      unit: "زلزلة",
      points: [
    ...
    },
    {
      ...
      columns: ["الخاصية", "ظهر المحيط", "غوص", "تصادم"],
      rows: [
    ...
    },
    {
      type: "flow",
      id: "doc3-plate-fate",
      title: "الوثيقة 3: مصير الصفيحة في منطقة الغوص",
      caption: "المراحل المتتالية لغوص الصفيحة المحيطية تحت الصفيحة القارية.",
      steps: ["صفيحة محيطية", "غوص", "غوص في البرنس", "انصهار جزئي", "صهارة أنديزيتية"],
      arrows: ["غوص", "احتكاك", "انصهار", "صعود"],
    },
    {
      type: "image",
      id: "doc4-subduction-zone-image",
      title: "الوثيقة 4: مقطع يوضح ظاهرة الغوص",
      caption: "مقطع جيولوجي يبين غوص الصفيحة المحيطية تحت الصفيحة القارية والبنيات المرافقة.",
      src: subductionSvg,
      alt: "رسم تخطيطي لمقطع في منطقة غوص يبين الصفيحة المحيطية والقارية والبركان والزلازل",
      annotations: [
        { x: 35, y: 40, label: "صفيحة قارية", tone: "success" },
        { x: 69, y: 40, label: "صفيحة محيطية", tone: "violet" },
        { x: 51, y: 72, label: "غوص", tone: "warning" },
  ...
  questions: [
    {
      ...
      skill: "تحليل الوثائق",
      docRef: "الوثيقة 1",
      prompt: "حلل الأعمدة البيانية في الوثيقة 1 التي تمثل توزيع الزلازل حسب العمق في منطقة غوص. صف التغير.",
      placeholder: "تمثل الأعمدة... نلاحظ أن عدد الزلازل... مع زيادة العمق...",
      modelAnswer: "تمثل الأعمدة البيانية توزيع الزلازل حسب العمق في منطقة غوص. نلاحظ أن عدد الزلازل يتناقص مع زيادة العمق: 120 زلزلة في 0-50 كم، 85 في 50-100 كم، 60 في 100-200 كم، 35 في 200-400 كم، و10 فقط في 400-700 كم. معظم الزلازل سطحية.",
    ...
    },
    {
      ...
      skill: "التفسير العلمي",
      docRef: "الوثيقتان 2 و3",
      prompt: "فسر اعتمادا على الوثيقتين 2 و3 العلاقة بين غوص الصفيحة وتشكل الصهارة الأنديزيتية.",
      placeholder: "يؤدي غوص الصفيحة إلى... حيث تسبب حرارة البرنس...",
      modelAnswer: "يؤدي غوص الصفيحة المحيطية (الوثيقة 3) إلى غوصها في البرنس حيث تتعرض لحرارة وضغط عاليين مما يسبب انصهارا جزئيا للصفيحة والصخور المحيطة، منتجا صهارة أنديزيتية (الوثيقة 2). تصعد هذه الصهارة مكونة براكين مميزة لمناطق الغوص.",
    ...
    },
    {
      ...
      skill: "المقارنة",
      docRef: "الوثيقة 2",
      prompt: "قارن بين البنيات التكتونية الثلاثة (ظهر المحيط، غوص، تصادم) اعتمادا على الوثيقة 2.",
      placeholder: "تختلف البنيات التكتونية الثلاثة في... ظهر المحيط... الغوص... التصادم...",
      modelAnswer: "تختلف البنيات التكتونية الثلاثة: ظهر المحيط (حدود تباعدية، تمدد، صهارة بازلتية، تشكل قشرة محيطية)، الغوص (حدود تقاربية، غوص، صهارة أنديزيتية، خندق وبراكين)، التصادم (حدود تقاربية، رفع، صهارة غرانيتية، سلاسل جبلية). أمثلة: أطلسي، أنديز، الهيمالايا.",
    ...
    },
    {
      ...
      skill: "إقامة العلاقات",
      docRef: "الوثيقة 1",
      prompt: "أقم علاقة بين توزيع الزلازل حسب العمق (الوثيقة 1) وعملية غوص الصفيحة.",
      placeholder: "يرتبط توزيع الزلازل بعملية الغوص حيث... الزلازل السطحية... والزلازل العميقة...",
      modelAnswer: "يرتبط توزيع الزلازل بمنطقة غوص الصفيحة حيث تمثل الزلازل السطحية (0-100 كم) منطقة الاحتكاك الأولى بين الصفيحتين، بينما تمثل الزلازل العميقة (100-700 كم) استمرار غوص الصفيحة في البرنس وتكسرها تحت تأثير الضغط والحرارة. تناقص عدد الزلازل مع العمق يدل على زيادة اللدونة.",
      learningFocus: "اربط بين عمق الزلزال ومرحلة الغوص: سطحية = احتكاك، عميقة = غوص.",
      mandatory: false,
    },
    {
      id: "scientific-text",
      ...
      skill: "النص العلمي",
      docRef: "الوثائق 1 و2 و3 و4",
      prompt: "اكتب نصا علميا تشرح فيه العلاقة بين حركة الصفائح والبنيات الجيولوجية المرتبطة بمناطق الغوص.",
      placeholder: "مقدمة... أولا: غوص الصفيحة... ثانيا: البنيات المرافقة... ثالثا: توزيع الزلازل... خاتمة...",
      modelAnswer: "تؤدي حركة الصفائح التكتونية إلى تشكل بنيات جيولوجية مميزة في مناطق الغوص. أولا، عند تقارب صفيحة محيطية مع قارية، تغوص المحيطية تحت القارية (الوثيقتان 3 و4) مسببة زلازل على أعماق متفاوتة تتناقص مع العمق (الوثيقة 1). ثانيا، يؤدي غوص الصفيحة وانصهارها الجزئي إلى تشكل صهارة أنديزيتية تصعد مكونة براكين (الوثيقة 2). ثالثا، يتميز الغوص بتشكل خندق محيطي وسلسلة براكين موازية له. في الختام، يعد الغوص آلية رئيسية في تشكل القشرة القارية وإعادة تدوير القشرة المحيطية.",
