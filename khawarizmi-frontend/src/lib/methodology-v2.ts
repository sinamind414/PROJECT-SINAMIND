...
const DEDUCE: EnrichedActionVerbRule = {
  ...
  enrichedBadExample: { answer: "نستنتج أن المنحنى يرتفع من 2 إلى 8 ثم ينخفض. وهذا راجع إلى أن الخلية تستعمل الغلوكوز في التنفس. كما نعلم أن التنفس الخلوي يتم في الميتوكندري. إذن فالغلوكوز ضروري.", errors: ["استنتاج طويل", "تكرار التحليل", "تحول إلى تفسير", "معلومة خارجية"], howToFix: "نختصر في جملة واحدة تجيب عن الهدف مباشرة." },
  enrichedCommonErrors: [
...
const DETERMINE: EnrichedActionVerbRule = {
  ...
  enrichedGoodExample: { instruction: "حدّد مكونات الخلية النباتية / حدّد آلية إنتاج الطاقة.", answer: "بمعنى اذكر : تتمثل مكونات الخلية النباتية في : جدار خلوي، غشاء هيولي، هيولى، نواة، صانعات، فجوة، ميتوكندري، غولجي، إندوبلازمية.\n\nبمعنى تعرّف+علل : تعريف آلية إنتاج الطاقة : هي التنفس الخلوي. تعليل : هدم كلي للغلوكوز في وجود الأكسجين، ينتج ATP، يتم في الميتوكندري. منطق : الهدم الكلي يحرر طاقة أكبر من الجزئي.", whyCorrect: "جرد واضح للذكر + تعريف وتحديد للآلية." },
