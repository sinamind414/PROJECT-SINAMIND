  ...
  if (!cours) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center space-y-4">
        ...
        <Link href="/cours" className="px-4 py-2 rounded-xl bg-violet-600 text-white text-sm font-bold hover:bg-violet-500 transition">
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 text-sm text-gray-500">
        ...
        <span>·</span>
        <span className={cours.importance === "critique" ? "text-red-400" : cours.importance === "haute" ? "text-amber-400" : "text-blue-400"}>
      ...
      <div dir="rtl" className="prose prose-invert prose-lg max-w-none">
        <ReactMarkdown
          ...
          components={{
            h1: ({ children }) => <h1 className="text-3xl font-bold text-white mb-4 mt-8 pb-2 border-b border-violet-500/30">{children}</h1>,
            h2: ({ children }) => <h2 className="text-2xl font-bold text-violet-400 mb-3 mt-6">{children}</h2>,
            h3: ({ children }) => <h3 className="text-xl font-semibold text-fuchsia-300 mb-2 mt-4">{children}</h3>,
            ...
            thead: ({ children }) => <thead className="bg-violet-500/20">{children}</thead>,
            ...
            code: ({ children }) => <code className="bg-slate-800 text-fuchsia-300 px-2 py-1 rounded text-sm font-mono">{children}</code>,
      ...
      <div className="flex min-h-screen" dir="rtl" style={{ background: "#1E1B2E" }}>
        ...
        <main className="flex-1 p-6 lg:p-8 overflow-auto order-2">
          <div className="max-w-6xl mx-auto space-y-6">
            ...
            <section>
              <div className="rounded-3xl p-6 bg-gradient-to-l from-indigo-700 to-violet-800">
