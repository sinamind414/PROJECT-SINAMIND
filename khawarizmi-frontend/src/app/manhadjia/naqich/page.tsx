...
import { isVerbeNaqich, type AtelierSatelliteData } from "@/lib/manhadjia-lib"
import rawData from "../../../../data/ateliers/manhadjia_s05_naqich_taam.json"
...
// قمر 05 — ناقش (verb_ref 9) : même machine d'états que le bootcamp,
// identité فضي, hors boucle J1→J7. 0 appel API, 0 LLM, 0 note /10.
export default function ManhadjiaNaqichPage() {
