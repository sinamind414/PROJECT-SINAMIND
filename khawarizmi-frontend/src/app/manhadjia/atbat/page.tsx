...
import { isVerbeAtbat, type AtelierSatelliteData } from "@/lib/manhadjia-lib"
import rawData from "../../../../data/ateliers/manhadjia_s03_atbat_taam.json"
...
// قمر 03 — أثبت (verb_ref 4) : même machine d'états que le bootcamp,
// identité فضي, hors boucle J1→J7. 0 appel API, 0 LLM, 0 note /10.
export default function ManhadjiaAtbatPage() {
