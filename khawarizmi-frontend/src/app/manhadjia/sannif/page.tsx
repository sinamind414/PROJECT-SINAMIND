...
import { isVerbeSannif, type AtelierSatelliteData } from "@/lib/manhadjia-lib"
import rawData from "../../../../data/ateliers/manhadjia_s10_sannif_taam.json"
...
// قمر 10 — صنّف (من الكتاب §6) : même machine d'états que le bootcamp,
// identité فضي, hors boucle J1→J7. 0 appel API, 0 LLM, 0 note /10.
export default function ManhadjiaSannifPage() {
