...
import { isVerbeTaaraf, type AtelierSatelliteData } from "@/lib/manhadjia-lib"
import rawData from "../../../../data/ateliers/manhadjia_s07_taaraf_taam.json"
...
// قمر 07 — تعرّف / سمّ (من الكتاب §1) : même machine d'états que le bootcamp,
// identité فضي, hors boucle J1→J7. 1 appel API officiel (remédiation phase ب, repli silencieux), 0 LLM, 0 note /10.
export default function ManhadjiaTaarafPage() {
