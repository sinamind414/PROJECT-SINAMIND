...
import { isVerbeFardiya, type AtelierSatelliteData } from "@/lib/manhadjia-lib"
import rawData from "../../../../data/ateliers/manhadjia_s04_fardiya_taam.json"
...
// قمر 04 — اقترح فرضية (verb_ref 8) : même machine d'états que le bootcamp,
// identité فضي, hors boucle J1→J7. 1 appel API officiel (remédiation phase ب, repli silencieux), 0 LLM, 0 note /10.
export default function ManhadjiaFardiyaPage() {
