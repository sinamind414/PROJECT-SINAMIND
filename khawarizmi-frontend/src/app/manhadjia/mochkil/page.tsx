...
import { isVerbeMochkil, type AtelierSatelliteData } from "@/lib/manhadjia-lib"
import rawData from "../../../../data/ateliers/manhadjia_s15_mochkil_taam.json"
...
// قمر 15 — صياغة مشكل علمي (من الكتاب §22) : même machine d'états que le bootcamp,
// identité فضي, hors boucle J1→J7. 0 appel API, 0 LLM, 0 note /10.
export default function ManhadjiaMochkilPage() {
