...
export function ActiveLessonHero({ lesson }: { lesson: ActiveLesson }) {
  ...
  return (
    <header className="rounded-3xl p-7 bg-gradient-to-l from-mint to-orange">
      ...
      {lesson.contentState === "gabarit-seul" && (
        <p className="mb-3 rounded-xl bg-black/20 border border-white/15 px-3 py-2 text-white/85 text-xs leading-relaxed">
          محتوى هذا الدرس لم يُكتب بعد. الصفحة تعرض الإطار المنهجي وطريقة الاستغلال، لا المعارف
