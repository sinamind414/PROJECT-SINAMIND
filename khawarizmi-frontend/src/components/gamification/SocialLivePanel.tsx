  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 grid grid-cols-2 sm:grid-cols-4 gap-3 mb-5">
        <StatPill emoji="👥" label="نشطون الآن" value={activeCount} color="emerald" />
        <StatPill emoji="📝" label="إجابات اليوم" value={phase5.questions_answered} color="blue" />
        <StatPill emoji="🎯" label="أكملوا الدرس" value={phase3.completed_today} color="amber" />
        <StatPill emoji="🏆" label="تحديات نشطة" value={mergedTop.length} color="violet" />
      </div>
