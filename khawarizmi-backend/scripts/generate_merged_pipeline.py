...
content = content.replace(
    '"notes": "OCR auto + preprocessing"', '"notes": "OCR auto + preprocessing", "source_page": page_no'
)
...
content = content.replace(
    'print(f"Traitement: KHELIFA {serie} Volume {vol}', 'log.info(f"Traitement: KHELIFA {serie} Volume {vol}'
)
content = content.replace(
    'print(f"  -> {len(questions)} questions extraites")', 'log.info(f"  -> {len(questions)} questions extraites")'
)
content = content.replace(
