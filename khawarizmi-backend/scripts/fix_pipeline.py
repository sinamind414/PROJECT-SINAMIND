...
content = content.replace(
    "from google.colab import drive, files", "# from google.colab import drive, files  (local mode)"
)
content = content.replace("drive.mount('/content/drive')", "# drive.mount('/content/drive')  (local mode)")
