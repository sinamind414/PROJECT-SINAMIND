...
INTENT_RULES = [
    {
        "intent": "orientation",
        "patterns": ["وش ندير", "من وين نبدا", "ماذا اراجع", "وين التركيز",
                     "خطة المراجعة", "وش نقرا", "بماذا ابدأ", "ماذا افعل",
                     "وش راك", "برنامج اليوم", "خطة اليوم"],
        "type": "orientation",
    },
    {
        "intent": "motivation",
        "patterns": ["خايف", "قلقان", "ما راني فاهم", "صعيب", "ماقدرتش",
                     "راني ضايع", "بزاف", "مرهق", "متعب", "يأس", "حابس",
                     "ما نقدرش", "صعبة", "معقد", "محبط"],
        "type": "motivation",
    },
    {
        "intent": "triche",
        "patterns": ["اعطني الحل", "اكتب الاجابة", "الحل كامل", "صحح لي بالكامل",
                     "عطيني الجواب", "الحل مباشرة", "اكتب لي", "عطيني التصحيح",
                     "لازم الاجابة"],
        "type": "refus",
    },
    {
        "intent": "feedback",
        "patterns": ["هل اجابتي", "صحيحة", "صحيح", "كيف اجابتي", "قيم اجابتي",
                     "وش راك تقول", "تقييم", "ملاحظة على اجابتي", "نقد"],
        "type": "feedback",
    },
    {
        "intent": "navigation",
        "patterns": ["اين درس", "وين الفصل", "اريد رابط", "كيف نروح ل",
                     "عرضني", "اين اجد", "وين الدرس", "اين الموضوع"],
        "type": "navigation",
    },
    {
        "intent": "sos_concept",
        "patterns": ["ما هو", "اشرح", "فهمت", "ما الفرق", "كيفاه يحدث",
                     "علاش", "ليش", "وش معناها", "ماذا يقصد", "متى يحدث",
                     "كيف يتم", "ماهو", "عرّف", "وضّح", "لماذا"],
        "type": "socratique",
    },
]
