...
VARIATION_MARKERS = ["يزداد", "تنخفض", "ثابت", "augmente", "diminue", "يتغير", "يرتفع", "ينخفض", "ارتفاع", "انخفاض"]
DOCUMENT_MARKERS = ["الوثيقة", "تمثل", "الشكل", "الجدول", "المنحنى", "الوثيقه", "يمثل", "وفق"]
...
VERB_RULES: dict[str, dict] = {
    ...
    "deduce": {
        ...
        "rules": [
            {
                "code": "deduction",
                "labelAr": "استعمال أدوات الاستنتاج",
                "points": 3,
                "checkType": "keyword",
                "keywordField": "required_markers",
            },
    ...
    "compare": {
        ...
        "rules": [
            {
                "code": "comparison",
                "labelAr": "استعمال أدوات المقارنة",
                "points": 3,
                "checkType": "keyword",
                "keywordField": "required_markers",
            },
