...
SYNONYMES = {
    ...
    "codon": [r"(?:ال)?رامزة", r"(?:ال)?كودون", r"ثلاثي\s+نكليوتيد"],
    "anticodon": [r"مضاد\s*(?:ال)?رامزة", r"(?:ال)?حامل\s+الثلاثي", r"anticodon"],
    ...
    "الرامزة المضادة": [r"مضاد\s*(?:ال)?رامزة", r"(?:ال)?حامل\s+الثلاثي", r"anticodon"],
    "المضاد الرامزة": [r"مضاد\s*(?:ال)?رامزة", r"(?:ال)?حامل\s+الثلاثي", r"anticodon"],
