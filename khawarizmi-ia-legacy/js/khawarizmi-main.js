...
const translations = {
  ar: {
    ...
    cta_subtitle: "انضم إلى آلاف الطلاب الذين يستعدون لبكالوريا " + getBacYear() + " مع خوارزمي IA",
  ...
  fr: {
    ...
    cta_subtitle: "Rejoignez des milliers de bacheliers qui préparent le BAC " + getBacYear(),
